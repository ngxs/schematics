...
describe('Generate ngxs starter kit', () => {
    ...
    it('should generate store in default root folder', () => {
        ...
        expect(files).toEqual([
            ...
            '/src/store/auth/model/auth.model.ts',
            ...
            '/src/store/dashboard/states/dictionary/model/dictionary-response.model.ts',
            ...
            '/src/store/dashboard/states/user/model/person.model.ts'
        ]);
    });
});
